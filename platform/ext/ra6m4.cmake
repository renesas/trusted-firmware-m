...
# This file gathers all RA6M4 specific files in the application.

# RA6M4 has a Cortex-M33 CPU.
...
set(FLASH_LAYOUT           "${PLATFORM_DIR}/target/renesas/ra6m4/partition/flash_layout.h")
set(PLATFORM_LINK_INCLUDES "${PLATFORM_DIR}/target/renesas/ra6m4/partition")
...
embedded_include_directories(PATH "${PLATFORM_DIR}/target/renesas/ra6m4" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/renesas/ra6m4/CMSIS_Driver/Config" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Config" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Include" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/renesas/ra6m4/Native_Driver" ABSOLUTE)
embedded_include_directories(PATH "${PLATFORM_DIR}/target/renesas/ra6m4/partition" ABSOLUTE)
...
if (TFM_PARTITION_PLATFORM)
    list(APPEND ALL_SRC_C_NS "${PLATFORM_DIR}/target/renesas/ra6m4/services/src/tfm_ioctl_ns_api.c")
endif()

if (NOT DEFINED BUILD_CMSIS_CORE)
    message(FATAL_ERROR "Configuration variable BUILD_CMSIS_CORE (true|false) is undefined!")
elseif (BUILD_CMSIS_CORE)
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Source/system_core_init.c")
endif()
...
elseif (BUILD_TIME)
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/renesas/ra6m4/Native_Driver/timer_cmsdk_drv.c")
    embedded_include_directories(PATH "${PLATFORM_DIR}/target/renesas/ra6m4/Native_Driver" ABSOLUTE)
endif()
...
elseif (BUILD_STARTUP)
    if (CMAKE_C_COMPILER_ID STREQUAL "ARMCLANG")
        list(APPEND ALL_SRC_ASM_S "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Source/armclang/startup_cmsdk_ra6m4_s.s")
        list(APPEND ALL_SRC_ASM_NS "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Source/armclang/startup_cmsdk_ra6m4_ns.s")
        list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Source/armclang/startup_cmsdk_ra6m4_bl2.s")
    elseif (CMAKE_C_COMPILER_ID STREQUAL "GNUARM")
        list(APPEND ALL_SRC_ASM_S "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Source/gcc/startup_cmsdk_ra6m4_s.S")
        list(APPEND ALL_SRC_ASM_NS "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Source/gcc/startup_cmsdk_ra6m4_ns.S")
        list(APPEND ALL_SRC_ASM_BL2 "${PLATFORM_DIR}/target/renesas/ra6m4/Device/Source/gcc/startup_cmsdk_ra6m4_bl2.S")
...
elseif (BUILD_TARGET_CFG)
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/renesas/ra6m4/target_cfg.c")
    list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/renesas/ra6m4/spm_hal.c")
    list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/renesas/ra6m4/attest_hal.c")
    list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/renesas/ra6m4/Native_Driver/mpu_armv8m_drv.c")
    if (TFM_PARTITION_PLATFORM)
        list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/renesas/ra6m4/services/src/tfm_platform_system.c")
        list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/renesas/ra6m4/services/src/tfm_ioctl_s_api.c")
    endif()
...
elseif(BUILD_PLAT_TEST)
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/renesas/ra6m4/plat_test.c")
endif()
...
elseif(BUILD_BOOT_HAL)
    ...
    list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/renesas/ra6m4/boot_hal.c")
endif()
...
#Default for RA6M4 is to disable the CC312 due to Windows build not being
#supported.
