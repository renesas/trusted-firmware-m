...
enum tfm_platform_err_t tfm_platform_flash_init(int32_t *result)
{
    enum tfm_platform_err_t ret;
    psa_invec in_vec;
    psa_outvec out_vec;
    ...
    args.type = TFM_FLASH_SERVICE_TYPE_INIT;
    ...
    ret = tfm_platform_ioctl(TFM_PLATFORM_IOCTL_FLASH_SERVICE,
                             &in_vec,
                             &out_vec);
...
enum tfm_platform_err_t tfm_platform_flash_erase(uint32_t address, uint32_t count, int32_t *result)
{
    enum tfm_platform_err_t ret;
    psa_invec in_vec;
    psa_outvec out_vec;
    ...
    args.type = TFM_FLASH_SERVICE_TYPE_ERASE;
    args.u.flash_erase.addr = address;
    args.u.flash_erase.count = count;
...
enum tfm_platform_err_t tfm_platform_flash_write(uint32_t *data, uint32_t flash_address, uint32_t count, int32_t *result)
{
    enum tfm_platform_err_t ret;
    psa_invec in_vec;
    psa_outvec out_vec;
    ...
    args.type = TFM_FLASH_SERVICE_TYPE_WRITE;
    args.u.flash_write.src_addr = (uint32_t)data;
    args.u.flash_write.flash_addr = flash_address;
    args.u.flash_write.count = count;
