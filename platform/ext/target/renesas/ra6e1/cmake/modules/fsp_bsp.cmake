...
if(EXISTS "${FSP_S_DIR}/ra/board/ra6e1_ek/board_init.c")
    target_sources(fsp_bsp PRIVATE ${FSP_S_DIR}/ra/board/ra6e1_ek/board_init.c)
endif()
if(EXISTS "${FSP_S_DIR}/ra/board/ra6e1_ek/board_leds.c")
    target_sources(fsp_bsp PRIVATE ${FSP_S_DIR}/ra/board/ra6e1_ek/board_leds.c)
endif()
...
target_include_directories(fsp_bsp
    PUBLIC
        ...
        ${FSP_S_DIR}/ra/fsp/src/bsp/mcu/ra6e1
