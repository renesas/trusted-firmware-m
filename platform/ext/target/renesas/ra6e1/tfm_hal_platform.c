 ...
 * ra6e1_bl2.ld resolves FSP's __StackSeal from the section it anchors.
 *
 * The discriminator is RA6E1_BUILDING_BL2, set by CMakeLists.txt on platform_bl2 alone -
