...
#   RA6E1_STDOUT_RTT ON  -> TF-M/MCUboot logs go to SEGGER RTT over J-Link
#                           (no UART wiring; the common uart_stdout.c is disabled
#                            and platform/.../rtt/rtt_stdout.c is compiled instead).
#   RA6E1_STDOUT_RTT OFF -> use the FSP SCI UART via the common uart_stdout.c.
# The FSP UART driver (cmsis_drivers/Driver_USART.c) is untouched in both cases;
# switching is just this one flag.
set(RA6E1_STDOUT_RTT                    ON                              CACHE BOOL      "Route TF-M/MCUboot stdout to SEGGER RTT instead of SCI UART")
if(RA6E1_STDOUT_RTT)
...
# Use Renesas-specific MCUboot (includes RA6E1 optimizations)
...
if(NOT DEFINED FSP_ROOT_DIR)
    ...
    set(FSP_ROOT_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../fsp_cmake/FSP_Project_ra6e1" CACHE STRING "FSP root directory")
endif()

############################ Platform Drivers ##################################

# Keep the stdout backend consistent with RA6E1_STDOUT_RTT set above
...
# Renesas RA6E1: 1MB Flash, 256KB RAM
# Flash layout depends on whether BL2 is enabled
#
# IMPORTANT: For the ra6e1 platform, the AUTHORITATIVE flash/RAM layout is the
