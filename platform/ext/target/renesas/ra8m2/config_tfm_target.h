...
/*
 * Entropy comes from the RSIP-E50D TRNG through PSA's external-RNG hook (sce_trng.c), not
 ...
 * its_flash_fs_validate_config(). With the RA8M2's 8 KB data flash the geometry is:
 *
 ...
 * ra8m2_layout_checks.c asserts the whole budget so it cannot regress silently. */
