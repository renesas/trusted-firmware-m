...
/*
 * RA parts have no MPC/PPC, so every platform_data_t here carries the PPC_SP_DO_NOT_CONFIGURE
 ...
 *
 * SCI0 base is 0x40118000 on RA8M2 (R_SCI0), 0x100 of register space. Taken as the "std
