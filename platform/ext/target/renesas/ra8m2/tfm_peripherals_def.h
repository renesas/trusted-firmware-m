 ...
 * built for UART output rather than RTT. The region is validated but not programmed: RA parts
 * attribute peripherals through PSAR/PSCU, so periph_ppc_bank is PPC_SP_DO_NOT_CONFIGURE and
