...
# links ra6m5_bl2.ld. So an FSP section that neither script names is not diagnosed - GNU ld
...
# with no diagnostic. See RA6M5_SOLUTION.md.
#
...
foreach(_var IMAGE AXF SCATTER OBJDUMP)
    if(NOT DEFINED ${_var})
        message(FATAL_ERROR "ra6m5_check_orphans: ${_var} not set")
    endif()
endforeach()
...
if(NOT _rc EQUAL 0)
    message(WARNING "RA6M5 [${IMAGE}]: objdump failed, orphan check skipped")
    return()
endif()
...
if(_orphans)
    string(REPLACE ";" "\n    " _list "${_orphans}")
    set(_msg
        "RA6M5 [${IMAGE}]: allocatable ORPHAN section(s) - present in the image, named "
        ...
        "Either handle the section in the script, or add it to RA6M5_ORPHAN_ALLOW in the "
