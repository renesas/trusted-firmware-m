 ...
 * ra6m5_bl2.ld resolves FSP's __StackSeal from the section it anchors.
 *
 * The discriminator is RA6M5_BUILDING_BL2, set by CMakeLists.txt on platform_bl2 alone -
