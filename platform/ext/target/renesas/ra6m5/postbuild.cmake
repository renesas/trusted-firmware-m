...
# Post-build script to generate SREC files for RA6M5
...
if(TARGET bl2 AND BL2)
    add_custom_command(TARGET bl2
        ...
        COMMAND ${CMAKE_COMMAND} -E echo "[RA6M5] Generated SREC: bin/bl2.srec"
...
if(TARGET tfm_s)
    add_custom_command(TARGET tfm_s
        ...
        COMMAND ${CMAKE_COMMAND} -E echo "[RA6M5] Generated SREC: bin/tfm_s.srec"
...
if(BL2)
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND} -E echo "[RA6M5] Generated SREC: bin/tfm_s_signed.srec (signed, base=0x00020000)"
...
if(TARGET bl2 AND BL2)
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND} -E echo "[RA6M5] Generated combined SREC: bin/tfm_combined.srec (BL2 + signed image)"
