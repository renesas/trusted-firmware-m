 ...
 * its_flash_fs_validate_config(). With the RA6M5's 8 KB data flash the geometry is:
 *
 ...
 * ra6m5_layout_checks.c asserts the whole budget so it cannot regress silently. */
