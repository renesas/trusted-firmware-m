...
#
# RA6M5 CPU architecture for the NON-SECURE build.
#
...
#
# Two layouts, one file: in the source tree this lives in ra6m5/ns/ with cpuarch.cmake one
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/cpuarch.cmake)
    ...
    # Source tree: platform/ext/target/renesas/ra6m5/ns/
    set(PLATFORM_DIR  ${CMAKE_CURRENT_LIST_DIR}/..)
    include(${CMAKE_CURRENT_LIST_DIR}/../cpuarch.cmake)
endif()
