...
#define BSP_FEATURE_ADC_TSN_CALIBRATION_AVAILABLE         (2U)       // TSCDR is a 32-bit register on this MCU
...
#define BSP_FEATURE_BSP_HAS_OCTASPI_CLOCK                 (0)  // Feature not available on this MCU TODO_CHECK_FEATURE
