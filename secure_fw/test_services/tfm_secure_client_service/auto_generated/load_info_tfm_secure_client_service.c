...
const struct partition_tfm_sp_secure_test_partition_load_info_t tfm_sp_secure_test_partition_load
    ...
    .assets                         = {
        {
            .mem.start              = PART_REGION_ADDR(PT_TFM_SP_SECURE_TEST_PARTITION_PRIVATE, _DATA_START$$Base),
            .mem.limit              = PART_REGION_ADDR(PT_TFM_SP_SECURE_TEST_PARTITION_PRIVATE, _DATA_END$$Base),
