...
/******** TFM_SP_ATTEST_TEST ********/
psa_status_t tfm_attest_test_get_public_key(psa_invec *, size_t, psa_outvec *, size_t);
...
#ifdef ATTEST_TEST_GET_PUBLIC_KEY
/******** TFM_SP_ATTEST_TEST ********/
TFM_VENEER_FUNCTION(TFM_SP_ATTEST_TEST, tfm_attest_test_get_public_key, tfm_attest_test_get_public_key)
#endif /* ATTEST_TEST_GET_PUBLIC_KEY */
