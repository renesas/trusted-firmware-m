...
const struct partition_tfm_sp_initial_attestation_load_info_t tfm_sp_initial_attestation_load
    ...
    .assets                         = {
        {
            .mem.start              = PART_REGION_ADDR(PT_TFM_SP_INITIAL_ATTESTATION_PRIVATE, _DATA_START$$Base),
            .mem.limit              = PART_REGION_ADDR(PT_TFM_SP_INITIAL_ATTESTATION_PRIVATE, _DATA_END$$Base),
